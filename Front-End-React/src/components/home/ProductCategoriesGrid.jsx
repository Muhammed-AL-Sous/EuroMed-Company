...
const ProductCategoriesGrid = () => {
  const getCategoryIcon = (code) => {
    switch (code) {
      ...
      case "TH":
        return <img src={totalHip} alt="Total-Hip" className="w-12 h-12" />;
      case "BP":
        return <img src={bipolar} alt="Bipolar" className="w-12 h-12" />;
      case "PS":
        return (
          <>
            <svg
  ...
  const { data } = useGetOperationTypesQuery();
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
          {initialCategories && initialCategories.length > 0 ? (
            ...
            <p className="text-md text-slate-900 font-semibold">
              No Product Categories Available , Soon ...
            </p>
          )}
        </div>
      </div>
